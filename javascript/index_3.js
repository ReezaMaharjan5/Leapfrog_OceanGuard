document.addEventListener('DOMContentLoaded' , () => {
    ...
    //      }
     ...
     // if(gameTrackCount === 3 || level === 3){
            ...
            //     collisionPlastic(floatPlastic, bulletElement);
            //     function collisionPlastic(floatPlastic, bulletElement){    
            //         //determining the position of each of the falling cans
            //         const rect3 = floatPlastic.getBoundingClientRect();
       
            //         const plasticTopPosition = rect3.top;
            //         const plasticLeftPosition = rect3.left;
            ...
            //         console.log("bleft",bulletLeftPosition ,"btop", bulletTopPosition, "pleft" ,plasticLeftPosition, "ptop", plasticTopPosition )
                  
       
            //        if(
            //            plasticTopPosition + canHeight >= bulletTopPosition 
            //        && plasticTopPosition <= bulletTopPosition
            //        && bulletLeftPosition + (i * canWidth)>= plasticLeftPosition + i * canWidth
            //        && bulletLeftPosition + (i * canWidth)< plasticLeftPosition + canWidth + i * canWidth
            //        ){
